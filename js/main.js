...
(function ($) {
    ...
    function isValidCountdownTarget(value) {
        if (!value) {
            return false;
        }
    ...
    function toCountdownPluginFormat(value) {
        var parsed = new Date(value);
    ...
    function startCountdown(target) {
        if (!$('#countdown-time').length || !$.fn.countdown) {
            return;
        }

        $('#countdown-time').countdown(target, function(event) {
    ...
    var countdownTarget = $('#countdown-time').attr('data-countdown-target');
    startCountdown(
        isValidCountdownTarget(countdownTarget)
            ? toCountdownPluginFormat(countdownTarget)
            : getDefaultCountdownTarget()
    );
